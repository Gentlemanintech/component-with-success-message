...
submitButton.addEventListener('click', e => {
    ...
    container.remove();
    successContainer.innerHTML += `<div>
    ...
    <p id = "s">A confirmation email has been sent to email@gmail.com. Please open it and click the button inside to confirm your subscription</p>
